package com.forcegym.rutinas.api;

import com.forcegym.rutinas.service.RutinaCatalogService;
...
public class RutinasController {
  ...
  public RoutineCatalogItem update(@PathVariable UUID routineId, @Valid @RequestBody UpsertRoutineRequest request) {
